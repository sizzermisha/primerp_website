            ...
            <div className={styles.Footer__inner + ' container'}>
                ...
                <ul className={styles.Footer__list}>
										{dataFooter.map((item, index) => (
											<li key={`footer_${item.key}_${index}`} className={styles.Footer__item}>
												<p className={styles.Footer__title}>{item.title}</p>
												<nav className='footer__navigation'>
														<ul className='footer__navlist'>
																{item.list.map((item, index) => {
																	return (<li key={`footer_${item.id}_${index}`} className='footer__navItem'>
																		<a href={item.href} className={styles.Footer__link}>
																			{item.text}
																		</a>
																	</li>)
																})}
								...
								<div className={styles.Footer__payments}>
									<img 
											src="/src/assets/icons/Footer/card-1.svg" 
											alt="visa"
									...
									<img 
										src="/src/assets/icons/Footer/card-2.svg" 
										alt="masterCard"
										className={styles.Footer__paymentCard}
										width={69.68}
										height={30.9}
									...
									<img 
											src="/src/assets/icons/Footer/card-3.svg" 
											alt="mir"
											className={styles.Footer__paymentCard}
											width={69.68}
											height={30.9}
